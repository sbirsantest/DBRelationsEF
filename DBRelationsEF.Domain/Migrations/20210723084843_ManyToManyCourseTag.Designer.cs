...
namespace DBRelationsEF.Domain.Migrations
{
    ...
    [Migration("20210723084843_ManyToManyCourseTag")]
    partial class ManyToManyCourseTag
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseTag", b =>
                {
                    b.HasOne("DBRelationsEF.Domain.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DBRelationsEF.Domain.Models.Tag", null)
                        .WithMany()
